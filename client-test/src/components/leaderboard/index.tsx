...
import { Award, ChevronLeft, ChevronRight, ChevronUp, Crown, Flame, Medal, Trophy, Zap } from "lucide-react"
          ...
          >
            ...
            {paginationReady ? (
              ...
              <div className="p-4 border-t flex justify-between items-center">
                <div className="h-5 w-32 bg-muted animate-pulse rounded ml-8"></div>
                <div className="flex items-center space-x-1">
                  <div className="h-8 w-8 bg-muted animate-pulse rounded-full"></div>
                  <div className="flex items-center space-x-1">
                    {Array.from({ length: 5 }).map((_, i) => (
                      <div key={i} className="h-8 w-8 bg-muted animate-pulse rounded-xl"></div>
                    ))}
                  </div>
                  <div className="h-8 w-8 bg-muted animate-pulse rounded-full"></div>
                </div>
