...
import { Trophy, Medal, Award, Moon, Sun, Zap, Flame, Crown, ChevronUp, ChevronLeft, ChevronRight } from "lucide-react"
import { Card } from "@/components/ui/card"
import { cn } from "@/lib/utils"

// Mock data for the leaderboard
const initialUsers = [
  { id: 1, username: "CodeMaster", points: 1250, problemsSolved: 42, streak: 7 },
  { id: 2, username: "AlgorithmAce", points: 980, problemsSolved: 36, streak: 5 },
  ...
  { id: 5, username: "LogicLegend", points: 650, problemsSolved: 25, streak: 2 },
  ...
  { id: 10, username: "FunctionFury", points: 380, problemsSolved: 14, streak: 2 },
  { id: 11, username: "PixelPioneer", points: 350, problemsSolved: 13, streak: 1 },
  { id: 12, username: "CodeCrusader", points: 320, problemsSolved: 12, streak: 5 },
  { id: 13, username: "StackSlayer", points: 310, problemsSolved: 11, streak: 2 },
  { id: 14, username: "ArrayArtisan", points: 290, problemsSolved: 10, streak: 3 },
  { id: 15, username: "ByteBaron", points: 270, problemsSolved: 9, streak: 1 },
  { id: 16, username: "NullNavigator", points: 250, problemsSolved: 8, streak: 4 },
  { id: 17, username: "RecursiveRanger", points: 230, problemsSolved: 7, streak: 2 },
  { id: 18, username: "VoidVanguard", points: 210, problemsSolved: 6, streak: 1 },
  { id: 19, username: "GitGuru", points: 190, problemsSolved: 5, streak: 3 },
  { id: 20, username: "PromiseProdigy", points: 170, problemsSolved: 4, streak: 2 },
  { id: 21, username: "MergeMarauder", points: 150, problemsSolved: 3, streak: 1 },
  { id: 22, username: "HashHero", points: 130, problemsSolved: 2, streak: 0 },
  { id: 23, username: "DjangoDefender", points: 110, problemsSolved: 1, streak: 0 },
  ...
  { id: 26, username: "PromiseProdigy", points: 170, problemsSolved: 4, streak: 2 },
  { id: 27, username: "MergeMarauder", points: 150, problemsSolved: 3, streak: 1 },
  { id: 28, username: "HashHero", points: 130, problemsSolved: 2, streak: 0 },
  { id: 29, username: "DjangoDefender", points: 110, problemsSolved: 1, streak: 0 },
    ...
    const interval = setInterval(() => {
      setUsers((prevUsers) => {
        ...
        updatedUsers[randomIndex] = {
          ...
          problemsSolved: updatedUsers[randomIndex].problemsSolved + (Math.random() > 0.7 ? 1 : 0), // 30% chance to solve a new problem
          streak: Math.random() > 0.8 ? updatedUsers[randomIndex].streak + 1 : updatedUsers[randomIndex].streak,
        }
                            ...
                            rank === 1
                              ...
                              : rank === 2
                                ...
                                : rank === 3
                                  ...
                                  : "",
                            (isUsernameHovered || isHovered) ? "text-blue-500" : "" // Change text to blue on hover
                          )}
