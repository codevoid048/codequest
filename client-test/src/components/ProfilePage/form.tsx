...
export default function ProfilePage() {
  ...
  const platforms = [
    ...
    { name: "GeeksForGeeks", handle: "alex_johnson", solved: 203, color: "#2F8D46" },
  ...
  return (
    <motion.div
      className="container mx-auto px-4 pt-15 pb-8"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      ...
      >
        ...
        <motion.div className="lg:col-span-3" variants={cardVariants}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <Card className="shadow-lg">
                <CardHeader className="pb-2">
                  <CardTitle className="text-lg flex items-center">
                    <Code2 className="mr-2 h-5 w-5 text-blue-500" /> Problems Solved
                  </CardTitle>
                </CardHeader>
                <CardContent>
            ...
            <motion.div variants={cardVariants}>
              <Card className="shadow-lg">
                <CardHeader className="pb-2">
                  <CardTitle className="text-lg flex items-center">
                    <Trophy className="mr-2 h-5 w-5 text-yellow-500" /> Total Points
                  </CardTitle>
                </CardHeader>
                <CardContent>
            ...
            <motion.div variants={cardVariants}>
              <Card className="shadow-lg">
                <CardHeader className="pb-2">
                  <CardTitle className="text-lg flex items-center">
                    <Flame className="mr-2 h-5 w-5 text-red-500" /> Current Streak
                  </CardTitle>
                </CardHeader>
                <CardContent>
          ...
          <Card className="mt-6 shadow-lg">
            <CardHeader>
              <CardTitle className="flex items-center">
                <Calendar className="mr-2 h-3 w-3 text-green-500" /> Contributions
              </CardTitle>
                ...
                <div className="flex gap-2">
                  ...
                  <div className="grid grid-cols-52 gap-1 flex-1">
                    {contributions.slice(0, 364).map((day, index) => (
                      <motion.div
                        key={index}
                        className={`h-4 w-4 rounded-sm ${day.count > 0 ? "bg-green-500" : "bg-muted/100"}`}
